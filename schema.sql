...
insert into category (name) value ("Bebidas");
insert into category (name) value ("Snacks y Acompanantes");
insert into category (name) value ("Postres");
insert into category (name) value ("Hamburguesas");
