			...
			<?php if (isset($_GET["product"])) : ?>
				...
				?>
								...
								<form method="post" action="index.php?view=addtocart">
									<tr class="<?php if ($q <= 5) {
										...
										<td>
											...
											<input type="number" class="form-control" required name="q" placeholder="Cantidad"></td>
										<td style="width:183px; text-align:center;">
											<button type="submit" class="btn btn-primary">
												<i class="glyphicon glyphicon-shopping-cart"></i> Agregar
											</button>
										</td>
									</tr>
								</form>
					...
					<?php if ($products_in_cero > 0) {
						echo "<p class='alert alert-warning'>Se omitieron <b>$products_in_cero productos</b> que no tienen existencias en el inventario. <a href='index.php?module=inventary'>Ir al Inventario</a>";
					} ?>

				<?php
				} else {
					echo "<p class='alert alert-warning'>No hay resultados en la busqueda.</p>";
				}
				?>
				<br>
				<hr>
					...
					<div class="col-md-6 col-md-offset-6">
						<table class="table table-bordered">
							<tr>
								...
								<td>
									<p><b>$ <?php echo number_format($total * .84); ?></b></p>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<p><b>$ <?php echo number_format($total * .18); ?></b></p>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<p><b>$ <?php echo number_format($total); ?></b></p>
								</td>
							</tr>
